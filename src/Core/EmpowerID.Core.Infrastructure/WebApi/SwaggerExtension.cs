namespace EmpowerID.Core.Infrastructure.WebApi;
        ...
        IConfiguration configuration)
    {
        ...
        services.AddSwaggerGen(s =>
        {
            s.SwaggerDoc(swaggerSettings.Version, new OpenApiInfo
            {
                ...
                Contact = new OpenApiContact { Name = "Kashif Saeed", Email = "mks786@gmail.com" },
                License = new OpenApiLicense() { Name = "MIT", Url = new Uri("https://github.com/mks786/EmpowerID/blob/main/LICENSE") }
            });
